                ...
                <div class="col-lg-4 col-md-6">
                    <div class="">
                        <div class="servcie2-box servcie2-box-2">
                            ...
                            <a href="/detailsservice/{{$vservice->slug}}" class="arrow"><i class="fa-solid fa-arrow-right"></i></a>
                            <div class="heading1">
                                <h4><a href="/detailsservice/{{$vservice->slug}}">{{$vservice->titre}}</a></h4>
                                <div class="space16"></div>
                                <p style="text-align: justify; text-justify: inter-word;">{!! Str::limit($vservice->contenu, 170, ' ..') !!}</p>
                            </div>
                        </div>
                    </div>
                </div>
