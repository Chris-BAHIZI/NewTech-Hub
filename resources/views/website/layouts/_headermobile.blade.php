        ...
        <div class="col-12">
            <div class="mobile-header-elements">
                <div class="mobile-logo">
                    <a href="{{route('accueil')}}"><img src="{{ asset('assets/img/newdesign/header-logo1.png') }}" alt=""></a>
                </div>
...
<div class="mobile-sidebar d-block d-lg-none">
    <div class="logo-m">
        <a href="{{route('accueil')}}"><img src="{{ asset('assets/img/newdesign/header-logo6.png') }}" alt=""></a>
    </div>
